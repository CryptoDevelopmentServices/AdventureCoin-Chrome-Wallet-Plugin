...
var advcqrcode = new QRCode(document.getElementById("advcqr"), {
    width: 100,
    height: 100,
    position: "center"
})
    ...
    function checkAPI() {
        apiCall().then(function(data) {
            if (data.error == null) {
                ...
                $("#currentBalance").text("Enter a valid AdventureCoin address")
...
function qrcodegen() {
    if (!document.getElementById("addressInput").value) {
        advcqrcode.makeCode("Enter an address")
    }
    else {
        advcqrcode.makeCode(document.getElementById("addressInput").value)
    }
}
